...
/*
			...
			"115"=hex:F4
			-or-
			"F1"=char code (ie 0xFC for ü), see iso-latin1 8859-1 https://en.wikipedia.org/wiki/ISO/IEC_8859-1
			to
			"F24"
*/
...
byte charMapDef_F1[]={	//25 values
	0xF1,	//	ñ	0x70 (VK_F1) -> 241 , 0x70-0x70
	0xF2,	//	ò	0x71 (VK_F2) -> 242 , 0x71
	0xF3,	//	ó	0x72 (VK_F3) -> 243 , 0x72
	0xF4,	//	ô	0x73 (VK_F4) -> 244 , 0x73
	0xF5,	//	õ	0x74 (VK_F5) -> 245 , 0x74
	0xF6,	//	ö	0x75 (VK_F6) -> 246 , 0x75
	0xF7,	//	÷	0x76 (VK_F7) -> 247 , 0x76
	0xF8,	//	ø	0x77 (VK_F8) -> 248 , 0x77
	0xF9,	//	ù	0x78 (VK_F9) -> 249 , 0x78
	0xFA,	//	ú	0x79 (VK_F10) -> 250 , 0x79
	0xFB,	//	û	0x7A (VK_F11) -> 251 , 0x7A
	0xFC,	//	ü	0x7B (VK_F12) -> 252 , 0x7B
	0xFD,	//	ý	0x7C -> VK_F13	-> 253
	0xFE,	//	þ	0x7D -> VK_F14	-> 254
	0xFF,	//	ÿ	0x7E -> VK_F15	-> 255
	0xE0,	//	à	0x7F -> VK_F16  -> 224
	0xE1,	//	á	0x80 -> VK_F17	-> 225
	0xE2,	//	â	0x81 -> VK_F18	-> 226
	0xE3,	//	ã	0x82 -> VK_F19	-> 227
	0xE4,	//	ä	0x83 -> VK_F20	-> 228
	0xE5,	//	å	0x84 -> VK_F21	-> 229
	0xE6,	//	æ	0x85 -> VK_F22	-> 230
	0xE7,	//	ç	0x86 -> VK_F23	-> 231
	0xE8,	//	è	0x87 -> VK_F24	-> 232
	0xE9,	//	é	0x88 -> VK_F25	-> 233
};
